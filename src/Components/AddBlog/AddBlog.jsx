        ...
        <div className="rounded-lg w-full flex flex-col gap-2 justify-center items-center h-[13.5rem]">
          {!image ? (
            ...
            <img
              src={image}
              alt="Image preview"
              className="h-[13.5rem] rounded-lg"
            />
          )}
        </div>
        <div className="flex flex-col mt-3 gap-8 p-1.5">
          <div className="flex items-center gap-3">
            <input
              ...
              required
              className="p-2 transition-all active:scale-[0.99] rounded-lg bg-blue-50 text-center text-blue-500 font-semibold placeholder-blue-500 outline-0 border-0"
            />
          </div>
          <div>
              ...
              <div>
                {!avatar ? (
                  <>
                    ...
                    >
                      <img
                        src="/assets/avatarAdd.png"
                        className="w-6 h-6 transition-all rounded-md cursor-pointer hover:scale-[0.99] active:scale-[0.98]"
                        alt="Add Avatar"
                      />
                    </label>
                    <input
