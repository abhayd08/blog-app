...
const Blog = ({ image, category, title, avatar, author, date, id }) => {
  ...
  return (
    <div
      ...
      className="rounded-lg cursor-pointer p-2 pb-3 hover:ring-blue-500 hover:ring-2 transition-all active:scale-[0.99] sm:p-2.5 ring-1 ring-gray-200 w-[20rem] max-w-xs"
    >
      <img
        src={image}
